          ...
          <div className="border-b border-gray-200 pb-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-medium text-gray-900">{orderId || 'ORD-' + Date.now()}</p>
              </div>
              <div>
                <span className="text-sm text-gray-500">Payment ID:</span>
                <p className="font-medium text-gray-900">{paymentId || 'PAY-' + Date.now()}</p>
              </div>
              <div>
          ...
          <div className="border-t border-gray-200 pt-6">
            <div className="flex justify-between items-center">
              ...
              <span className="text-2xl font-bold text-green-600">
                ${orderDetails?.final_amount || '0.00'}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Order Verification</h3>
              <p className="text-sm text-gray-600">We're verifying your payment and preparing your premium accounts.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Your premium accounts are being set up and will be ready shortly.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Account details will be sent to your email within 24 hours.</p>
            </div>
          </div>
        </div>
